...
namespace ParkMobileServer.Migrations
{
    ...
    [Migration("20250222085230_AddTrackNumberMigration")]
    partial class AddTrackNumberMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkMobileServer.Entities.Orders.OrderClient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ParkMobileServer.Entities.Orders.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ParkMobileServer.Entities.Orders.OrderClient", b =>
                {
                    b.HasOne("ParkMobileServer.Entities.Orders.Order", "Order")
                        .WithOne("Client")
                        .HasForeignKey("ParkMobileServer.Entities.Orders.OrderClient", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
